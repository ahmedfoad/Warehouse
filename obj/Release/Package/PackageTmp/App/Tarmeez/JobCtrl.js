var Search;
var page = 0;
app.controller("JobCtrl", function ($scope, $http, $window, $timeout, $fancyModal) {
    $scope.Job = { ID: 0,   Name: "" };
    ...
    //----------------------------------------------------------------------------------------------------------------------------
    //----------------------------------------------------------------------------------------------------------------------------
    // get data of Job with scrolling 
    //----------------------------------------------------------------------------------------------------------------------------
    ...
    // add new Job
    //----------------------------------------------------------------------------------------------------------------------------
    $scope.SaveData = function (Job) {
        
        var CheckForm = $scope.Form_Validation(Job);
        if (CheckForm == true) {
            $scope.DBsave(Job);
        }
        else {
    ...
    $scope.DBsave = function (Job) {

        var parameter = JSON.stringify(Job);
        if ($scope.Job.ID == 0) {
            $http.post('/Job/Insert', parameter)
                 .success(function (response) {
    ...
    // Form Validation
    //----------------------------------------------------------------------------------------------
    $scope.Form_Validation = function (Job) {
    ...
    $scope.Edit = function (Job) {
        //DataService.Job(Deparment);
        //// 
        $fancyModal.open({
            template:
            "<div class='row' ng-controller='JobCtrl' style='height:200px;'>                                                                                                                             "
+ "    <div class='col-md-12'>                                                                                                                                                                       "
+ "                                                                                                                                                                                                  "
...
+ "                    <input id='Name'  value='" + Job.Name + "'  class='form-control' placeholder='اسم المهنة' type='text' />                                                          "
+ "                    <input id='ID' type='hidden' value='" + Job.ID + "'/>                                                                                              "
+ "                </div>"
+ "                                                                                                                                                                                                  "
+ "            </div>                                                                                                                                                                                "
...
+ "</div>                                                                                                                                                                                            "
    ...
    $scope.EditData = function () {
        ...
        $scope.Job = { ID: document.getElementById("ID").value, Name: document.getElementById("Name").value };
        var CheckForm = $scope.Form_Validation($scope.Job);
        if (CheckForm == true) {
            $scope.DBsave($scope.Job);
        }
        else {
            $scope.AlertParameter = 1;
            document.body.scrollTop = 0;
...
+ "                <div class='row' style='margin: auto;'>                                                                                                                                           "
+ "                    <label for='Name'>اسم المهنة</label>                                                                                                                                   "
+ "                    <input id='Name' readonly='readonly' value='" + Job.Name + "'  class='form-control' placeholder='اسم المهنة' type='text' />                                                          "
+ "                    <input id='ID' type='hidden' value='" + Job.ID + "'/>                                                                                              "
+ "                                                                                                                                                                                                  "
+ "                </div>                                                                                                                                                                            "
