var page = 0;
app.controller("MasrofatListCtrl", function ($scope, $http, $window, $timeout, $uibModal) {
    ...
    $scope.BtnPrint = function () {
        ...
        $scope.Srch_Masrofat.Date_Invoice_From = $("#Date_Invoice_From").val();
        $scope.Srch_Masrofat.Date_Invoice_TO = $("#Date_Invoice_TO").val();
        var myurl= "/Report_Masrofat/Pdf?Date_Invoice_From=" + $scope.Srch_Masrofat.Date_Invoice_From + "&Date_Invoice_TO=" + $scope.Srch_Masrofat.Date_Invoice_TO;
        $http({
            url: myurl,
            method: "GET",
            headers: {
