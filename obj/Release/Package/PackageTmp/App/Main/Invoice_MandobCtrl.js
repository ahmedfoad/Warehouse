app.controller("Invoice_MandobCtrl", function ($scope, $http, $window, $timeout, $uibModal) {
    ...
    $scope.scanCallback = function (word) {
        ...
        //  $scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[0].Product_Name = word;
          ...
          .success(function (response) {
              ...
              if (response != null && response != "") {
                  ...
                  if (index == -1) {
                      ...
                      $scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[index].Product_Id = response.ID;
                      $scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[index].Product_Name = response.Name;
                      $scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[index].Amount = 1;
                      $scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[index].Price = parseFloat(response.Price_Unit);
                      $scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[index].Price_Mowrid = parseFloat(response.Price_Mowrid);
                      ...
                      if ($scope.Cls_Invoice_Mandob.ClsInvoiceMandob_Product[index].Product_Name == response.Name) {
    ...
    $scope.Intialize_product = function () {
        $scope.Cls_Invoice_Mandob = {
            ...
            ID: "", Invoice_Number: "", Mandob_id: "", Mandob_Name: "", Date_Invoice: "", Date_Invoice_Hijri: "", Price: 0, Total_Sadad: "", Price_Mowrid: 0, Payment_Type: 1,
    ...
    //---------------------------------------------------------------------------------ب-------------------------------------------
    //------------------تحميل الصنفات بعد فتح النافذة
    $scope.getAllRecords = function (Page, Search, Src_Barcode) {
